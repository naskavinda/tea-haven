    ...
    <footer className="bg-green-800 text-white py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p>TeaHaven is your destination for premium teas from around the world.</p>
        </div>
        <div>
          <h3 className="text-xl font-serif mb-4">Quick Links</h3>
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-green-200">FAQ</a></li>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto mt-8 pt-8 border-t border-green-700 text-center">
        <p>&copy; 2023 TeaHaven. All rights reserved.</p>
      </div>
    </footer>
  );
};
